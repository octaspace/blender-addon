...
def blender(blend_file_name, render_format="PNG", debug_cycles=False):
    return {
        "operation": "exe",
        ...
        "variables": [
            ...
            "--debug-cycles" if debug_cycles else "",
            "--verbose 5" if debug_cycles else "",
        ],
    }
...
def get_operations(
    blend_file_name, render_format, max_thumbnail_size, zip_hash, debug_cycles=False
):
    return [
